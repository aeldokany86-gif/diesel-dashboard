...
export function printReport({
  ...
  if (!printWindow) {
    window.alert(translate("Please allow pop-ups to print the report."));
    return;
  }
    ...
    .map(
      (item) => `
        <div class="meta-card">
          ...
          <strong>${escapeHtml(translate(item.value))}</strong>
        </div>
      `
    )
    .join("");
    ...
    <html lang="${language === "ar" ? "ar" : "en"}" dir="${language === "ar" ? "rtl" : "ltr"}">
      ...
      <body>
        <header class="header">
          ...
          <div class="generated">
            <div><strong>${escapeHtml(translate("Generated"))}:</strong> ${escapeHtml(generatedAt)}</div>
            <div><strong>${escapeHtml(translate("Generated By"))}:</strong> ${escapeHtml(generatedBy)}</div>
          </div>
        </header>
        ...
        ${note ? `<div class="footer-note">${escapeHtml(translate(note))}</div>` : ""}
        <div class="footer-note">${escapeHtml(translate("Generated by Fleet Fuel PRO"))}</div>
